...
public class EditMoviesPanel extends javax.swing.JPanel {
    ...
    private MovieTableModel articlesTableModel;
    ...
    private void initComponents() {
        ...
        lDirectors = new javax.swing.JList<>();
        jLabel1 = new javax.swing.JLabel();
        jScrollPane4 = new javax.swing.JScrollPane();
        lActors = new javax.swing.JList<>();
        ...
        jScrollPane3.setViewportView(lDirectors);

        jLabel1.setText("Directors");

        jScrollPane4.setViewportView(lActors);

        jLabel6.setText("Actors");

        jLabel7.setText("Genres");

        jScrollPane6.setViewportView(lGenres);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btnUpdate, javax.swing.GroupLayout.DEFAULT_SIZE, 402, Short.MAX_VALUE))
    ...
    private javax.swing.JList<Actor> lActors;
    private javax.swing.JList<Director> lDirectors;
    private javax.swing.JList<Genre> lGenres;
    ...
    private void initTable() throws Exception {
        ...
        articlesTableModel = new MovieTableModel(repository.selectMovies());
        tbArticles.setModel(articlesTableModel);
    }
    
    private void loadList() throws Exception {
        Object[] toActorObjectArray = repository.selectActorsFromMovie(selectedMovie).toArray();
        Actor[] actorArray = Arrays.copyOf(toActorObjectArray, toActorObjectArray.length, Actor[].class);
        lActors.setListData(actorArray);
        
        Object[] toDirectorObjectArray = repository.selectDirectorsFromMovie(selectedMovie).toArray();
        Director[] directorArray = Arrays.copyOf(toDirectorObjectArray, toDirectorObjectArray.length, Director[].class);
        lDirectors.setListData(directorArray);
        
        Object[] toGenreObjectArray = repository.selectGenresFromMovie(selectedMovie).toArray();
        Genre[] genreArray = Arrays.copyOf(toGenreObjectArray, toGenreObjectArray.length, Genre[].class);
        lGenres.setListData(genreArray);
    }
    ...
    private void fillForm(Movie article) {
        ...
        tfPublishedDate.setText(article.getPublishedDate().format(Movie.DATE_FORMATTER));
    }
